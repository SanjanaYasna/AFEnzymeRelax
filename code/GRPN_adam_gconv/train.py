...
writer = SummaryWriter(f"/kuhpc/scratch/slusky/syasna_sta/rpn_metrics/GRPN_adam_gconv/tensorboard")
...
#loss files 
loss_file = open("/kuhpc/work/slusky/syasna_sta/func_pred/code/GRPN_adam_gconv/losses.csv", "a")
...
for epoch in range(0, num_epochs+1):
    ...
    torch.save(model.state_dict(), f"/kuhpc/scratch/slusky/syasna_sta/rpn_metrics/GRPN_adam_gconv/weights/epoch_{epoch}.pt")
